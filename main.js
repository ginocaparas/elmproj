...
var $author$project$Main$subscriptions = function (model) {
	return $elm$browser$Browser$Events$onResize(
		F2(
			function (w, h) {
				return $author$project$Main$ViewportReceived(
					{height: h, width: w});
			}));
};
				...
				A2(
					...
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$Background$color($phollyer$elm_ui_colors$Colors$Opaque$white)
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									...
									$mdgriffith$elm_ui$Element$Font$color($phollyer$elm_ui_colors$Colors$Opaque$white),
									...
									$mdgriffith$elm_ui$Element$Background$color($phollyer$elm_ui_colors$Colors$Opaque$black)
								]),
							$mdgriffith$elm_ui$Element$text('Stream Engine Studios')),
							A2(
							...
							_List_fromArray(
								[
									...
									$mdgriffith$elm_ui$Element$Border$color($phollyer$elm_ui_colors$Colors$Opaque$grey)
								]),
							_List_fromArray(
								[
									A2(
									...
									_List_fromArray(
										[
											...
											A3($mdgriffith$elm_ui$Element$rgb255, 177, 177, 177)),
											$mdgriffith$elm_ui$Element$Background$color(
											A4($mdgriffith$elm_ui$Element$rgba, 0.7, 0.7, 0.7, 0.5)),
									...
									_List_fromArray(
										[
											...
											$mdgriffith$elm_ui$Element$text('Lorem'),
											$mdgriffith$elm_ui$Element$text('Ipsum')
										])),
									A2(
									$mdgriffith$elm_ui$Element$el,
									_List_fromArray(
